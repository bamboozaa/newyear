            ...
            if ($entries[0]['count'] >= 1) {
                ...
                if (!$check) {
                    ...
                    // ถ้าไม่เจอให้เด้งออกเลย
                        echo "<script>alert('ไม่พบหน่วยงานที่คุณสังกัดในระบบ โปรดติดต่อผู้ดูแลระบบ');</script><meta http-equiv=\"refresh\" content=\"0; url=index.php\">";
                    }*/ // end if   
                } else {
                    $arr_update = array('last_login_date' => date('Y-m-d H:i:s'));
