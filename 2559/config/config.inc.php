...
define("DATABASE_USER" , "newyearrandom");
define("DATABASE_PASS" , "RaEaWq3xFOVZc3rf5AOD");
define('TBL_EMPLOYEE', 'tbl_employee_newyear2559');
define('TBL_DEPARTMENT', 'department_emp2561');
define("APP_TITLE", "ระบบจับฉลากปีใหม่");
define("APP_VERSION", "2559");
define("ACADYEAR", "2559");
